...
function discount($discount_plan,$payment_id,$discount_percentage,$discount_pA){
    ...
    if ($discount_plan != null){
        if($discount_plan == "Fixed"){//Fixed discount calculation 
        ...
        }elseif($discount_plan == "Variable"){ //Variable discount calculation
            ...
            for($i=0;$i<=sizeof($task_row);$i++){
                ...
                if($discount_percentage[$i] = null || $discount_pA[$i] = 0){
                    $discount_rate = 0; 
                }
            ...
            if($total_price2[0] <= 2000 and $total_price2>1000 ){
                $discount_percent= 1;
