<?php
    ...
    $paym_card_exp = strtotime($_POST['exp-date']);
    ...
    if ($paym_type == "Card" && $check) {
        ...
        $insert_card_query->bind_param("ssssi", $last_four_digits, $paym_card_name, $paym_card_exp, $paym_card_type, $payment_identifier);
